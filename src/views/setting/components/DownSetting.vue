    ...
    <div>
        <el-form  label-width="auto" label-position="right">
            <el-form-item label="下载线程数">
                <div>
                    <el-input-number v-model="form.downLimit" :min="1" :max="256" />
                    <div><el-text class="setting-tip" type="info">同一个任务内下载的线程数，不建议设置太大 。设置大了可能会触发反爬虫机。总线程数=下载中任务数*下载线程数</el-text></div>
                </div>
            </el-form-item>
             <el-form-item>
