<template>
    <div>
        <el-tabs v-model="activeName" class="tabs">
            <el-tab-pane :label="`下载中(${downTaskStore.downloadTasks.length})`" name="1">
            ...
            <el-tab-pane :label="`已完成(${downTaskStore.finishTasks.length})`" name="2">
...
import { de } from 'element-plus/es/locales.mjs';
    ...
    watch(() => downTaskStore.selectTask.taskStatus, (val) => {
       if(val=='completed'){
           activeName.value = '2'
       }
    })
